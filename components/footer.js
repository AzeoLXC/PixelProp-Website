        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex flex-col md:flex-row justify-between items-center mb-8 md:mb-12 text-center md:text-left">
              <div class="mb-4 md:mb-0">
                <a href="${basePath}/" class="inline-flex items-center justify-center md:justify-start gap-3 mb-4 group">
                  ...
                  <span class="text-lg md:text-xl font-bold text-slate-900 dark:text-white tracking-tight group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">Pixel Prop Project</span>
                </a>
